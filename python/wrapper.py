...
def send_peer(x,y,z,time) :
    udp_peer_lib.send_coor.argtypes = [ctypes.c_float,ctypes.c_float,ctypes.c_float,ctypes.c_uint64]
    udp_peer_lib.send_coor(x,y,z,time)

def callbackType() :
    return ctypes.CFUNCTYPE(None,ctypes.c_float,ctypes.c_float,ctypes.c_float,ctypes.c_uint64)
